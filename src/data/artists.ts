...
export const ARTISTS: SeedArtist[] = [
  ...
  // ── Added batch: popular gaps (2026-06-08) ────────────────────────────────
  // Pop-EDM / future bass crossover
  {
    id: "the-chainsmokers",
    name: "The Chainsmokers",
    aka: ["chainsmokers", "andrew taggart", "alex pall"],
    genres: ["futurebass", "electrohouse", "prog"],
    blurb: "Pop-EDM duo whose hook-first future bass defined late-2010s crossover radio.",
    topTracks: [
      { title: "Closer", genres: ["futurebass", "prog"] },
      { title: "Don't Let Me Down", genres: ["futurebass", "trap"] },
      { title: "Roses", genres: ["futurebass", "electrohouse"] },
      { title: "Something Just Like This", genres: ["futurebass", "prog"] },
      { title: "Paris", genres: ["futurebass"] },
    ],
  },
  {
    id: "jai-wolf",
    name: "Jai Wolf",
    aka: ["sajeeb saha"],
    genres: ["futurebass", "meldubstep", "prog"],
    blurb: "Bangladeshi-American producer of widescreen, festival-sunset future bass.",
    topTracks: [
      { title: "Indian Summer", genres: ["futurebass", "prog"] },
      { title: "Starlight", genres: ["futurebass", "meldubstep"] },
      { title: "Lose My Mind", genres: ["futurebass"] },
      { title: "Like It's Over", genres: ["futurebass"] },
      { title: "Gravity", genres: ["meldubstep", "futurebass"] },
    ],
  },
  {
    id: "petit-biscuit",
    name: "Petit Biscuit",
    aka: ["mehdi benjelloun"],
    genres: ["futurebass", "meldubstep"],
    blurb: "French producer who wrote the viral 'Sunset Lover' as a teenager and built a lush future-bass world.",
    topTracks: [
      { title: "Sunset Lover", genres: ["futurebass"] },
      { title: "Beam", genres: ["futurebass"] },
      { title: "Suffer", genres: ["futurebass", "meldubstep"] },
      { title: "We Were Young", genres: ["futurebass"] },
    ],
  },
  {
    id: "cashmere-cat",
    name: "Cashmere Cat",
    aka: ["magnus august hoiberg"],
    genres: ["futurebass", "trap"],
    blurb: "Norwegian former turntablist whose delicate, off-kilter future bass reshaped pop production.",
    topTracks: [
      { title: "Mirror Maru", genres: ["futurebass"] },
      { title: "With Me", genres: ["futurebass", "trap"] },
      { title: "Wedding Bells", genres: ["futurebass"] },
      { title: "9 (After Coachella)", genres: ["futurebass"] },
    ],
  },
  {
    id: "mura-masa",
    name: "Mura Masa",
    aka: ["alex crossan"],
    genres: ["futurebass", "ukg", "trap"],
    blurb: "Guernsey producer blending future bass, garage and pop into a restless, sample-bright sound.",
    topTracks: [
      { title: "Lovesick", genres: ["futurebass"] },
      { title: "What If I Go?", genres: ["futurebass", "ukg"] },
      { title: "Complicated", genres: ["futurebass"] },
      { title: "Firefly", genres: ["futurebass", "ukg"] },
    ],
  },

  // House / progressive / festival / big room
  {
    id: "kaskade",
    name: "Kaskade",
    aka: ["ryan raddon"],
    genres: ["prog", "house", "deep"],
    blurb: "Chicago house veteran who made emotive progressive house an American main-stage staple.",
    topTracks: [
      { title: "Atmosphere", genres: ["prog"] },
      { title: "Move for Me", genres: ["prog", "house"] },
      { title: "Angel on My Shoulder", genres: ["prog", "electrohouse"] },
      { title: "I Remember", genres: ["prog", "house"] },
      { title: "Disarm You", genres: ["prog", "futurebass"] },
    ],
  },
  {
    id: "galantis",
    name: "Galantis",
    aka: ["christian karlsson", "linus eklow", "style of eye"],
    genres: ["futurehouse", "futurebass", "bigroom"],
    blurb: "Swedish duo whose chipmunk-vocal hooks turned future house into pure festival serotonin.",
    topTracks: [
      { title: "Runaway (U & I)", genres: ["futurehouse", "futurebass"] },
      { title: "No Money", genres: ["futurehouse", "bigroom"] },
      { title: "Peanut Butter Jelly", genres: ["futurehouse"] },
      { title: "Hunter", genres: ["futurehouse", "futurebass"] },
    ],
  },
  {
    id: "justice",
    name: "Justice",
    aka: ["gaspard auge", "xavier de rosnay"],
    genres: ["electrohouse", "frenchhouse", "prog"],
    blurb: "French duo whose distorted, disco-baroque electro made the cross album a generational statement.",
    topTracks: [
      { title: "D.A.N.C.E.", genres: ["frenchhouse", "electrohouse"] },
      { title: "Genesis", genres: ["electrohouse"] },
      { title: "Safe and Sound", genres: ["frenchhouse", "electrohouse"] },
      { title: "Stress", genres: ["electrohouse"] },
    ],
  },
  {
    id: "nicky-romero",
    name: "Nicky Romero",
    aka: ["nick rotteveel"],
    genres: ["bigroom", "prog", "electrohouse"],
    blurb: "Dutch producer and Protocol boss who bridged big-room drops and progressive melody.",
    topTracks: [
      { title: "Toulouse", genres: ["bigroom", "electrohouse"] },
      { title: "I Could Be the One", genres: ["prog", "bigroom"] },
      { title: "Legacy", genres: ["bigroom", "prog"] },
      { title: "Like Home", genres: ["prog"] },
    ],
  },
  {
    id: "kshmr",
    name: "KSHMR",
    aka: ["niles hollowell-dhar", "the cataracs"],
    genres: ["bigroom", "electrohouse", "trap"],
    blurb: "Producer whose cinematic, world-music-laced big room is a festival main-stage mainstay.",
    topTracks: [
      { title: "Secrets", genres: ["bigroom"] },
      { title: "Jammu", genres: ["bigroom"] },
      { title: "Carry Me Home", genres: ["bigroom", "electrohouse"] },
      { title: "Bazaar", genres: ["bigroom"] },
    ],
  },
  {
    id: "w-and-w",
    name: "W&W",
    aka: ["willem van hanegem", "ward van der harst"],
    genres: ["bigroom", "trance", "psytrance"],
    blurb: "Dutch duo who pivoted from uplifting trance to high-octane 'Mainstage' festival sound.",
    topTracks: [
      { title: "Bigfoot", genres: ["bigroom"] },
      { title: "Rocket", genres: ["bigroom"] },
      { title: "Lift Off!", genres: ["bigroom", "trance"] },
      { title: "Mainstage", genres: ["bigroom", "trance"] },
    ],
  },
  {
    id: "r3hab",
    name: "R3HAB",
    aka: ["fadil el ghoul"],
    genres: ["bigroom", "electrohouse", "futurehouse"],
    blurb: "Moroccan-Dutch hitmaker turning out a relentless stream of radio-ready future house.",
    topTracks: [
      { title: "All Around the World (La La La)", genres: ["futurehouse", "bigroom"] },
      { title: "Lullaby", genres: ["futurehouse"] },
      { title: "Flames", genres: ["futurehouse"] },
      { title: "Icarus", genres: ["bigroom", "electrohouse"] },
    ],
  },
  {
    id: "timmy-trumpet",
    name: "Timmy Trumpet",
    aka: ["timothy jude smith"],
    genres: ["bigroom", "psytrance", "hardstyle"],
    blurb: "Australian showman who plays trumpet over the drop — 'Freaks' and 'Narco' are stadium anthems.",
    topTracks: [
      { title: "Freaks", genres: ["bigroom"] },
      { title: "Narco", genres: ["bigroom", "psytrance"] },
      { title: "Oracle", genres: ["bigroom"] },
      { title: "The Buzz", genres: ["bigroom"] },
    ],
  },
  ...
  // Tropical / pop-dance
  {
    ...
    aka: ["felix de laet"],
    genres: ["tropical", "deep", "house"],
    blurb: "Belgian producer who turned breezy deep-house-pop into chart-topping tropical anthems.",
    topTracks: [
      { title: "Are You with Me", genres: ["tropical"] },
      { title: "Reality", genres: ["tropical"] },
      { title: "Where Are You Now", genres: ["tropical", "deep"] },
      { title: "Crazy", genres: ["tropical"] },
    ],
  },
  {
    id: "jonas-blue",
    name: "Jonas Blue",
    aka: ["guy james robin"],
    genres: ["tropical", "house", "futurehouse"],
    blurb: "British producer of sun-drenched tropical-house covers and originals built for summer radio.",
    topTracks: [
      { title: "Fast Car", genres: ["tropical"] },
      { title: "Rise", genres: ["tropical", "futurehouse"] },
      { title: "Mama", genres: ["tropical"] },
      { title: "By Your Side", genres: ["tropical", "house"] },
    ],
  },
  {
    id: "felix-jaehn",
    name: "Felix Jaehn",
    genres: ["tropical", "house", "deep"],
    blurb: "German DJ whose tropical-house remix of 'Cheerleader' helped launch the whole sound.",
    topTracks: [
      { title: "Ain't Nobody (Loves Me Better)", genres: ["tropical"] },
      { title: "Cheerleader", genres: ["tropical"] },
      { title: "Bonfire", genres: ["tropical"] },
      { title: "Hot2Touch", genres: ["tropical", "house"] },
    ],
  },
  {
    id: "sigala",
    ...
    aka: ["bruce fielder"],
    genres: ["tropical", "house", "futurehouse"],
    blurb: "British hitmaker stacking up piano-driven tropical and pop-house singles.",
    topTracks: [
      { title: "Sweet Lovin'", genres: ["tropical", "house"] },
      { title: "Easy Love", genres: ["tropical"] },
      { title: "Came Here for Love", genres: ["tropical", "house"] },
      { title: "Lullaby", genres: ["tropical"] },
    ],
  },

  // Melodic house & techno / deep / underground
  {
    id: "rufus-du-sol",
    name: "RÜFÜS DU SOL",
    aka: ["rufus", "rufus du sol"],
    genres: ["melodic", "deep", "prog"],
    blurb: "Australian live trio whose euphoric, song-driven melodic house fills arenas.",
    topTracks: [
      { title: "Innerbloom", genres: ["melodic", "deep"] },
      { title: "Underwater", genres: ["melodic"] },
      { title: "Alive", genres: ["melodic", "prog"] },
      { title: "On My Knees", genres: ["melodic"] },
      { title: "No Place", genres: ["melodic", "deep"] },
    ],
  },
  {
    id: "peggy-gou",
    name: "Peggy Gou",
    aka: ["kim min-ji"],
    genres: ["house", "techno", "deep"],
    blurb: "Korean DJ and designer whose retro-leaning house made her a crossover star.",
    topTracks: [
      { title: "(It Goes Like) Nanana", genres: ["house"] },
      { title: "It Makes You Forget (Itgehane)", genres: ["house", "techno"] },
      { title: "Starry Night", genres: ["house"] },
      { title: "I Go", genres: ["house", "deep"] },
    ],
  },
  {
    id: "solomun",
    name: "Solomun",
    aka: ["mladen solomun"],
    genres: ["melodic", "deep", "techno"],
    blurb: "Bosnian-German Diynamic boss and Ibiza headliner defining hypnotic, emotive melodic house.",
    topTracks: [
      { title: "Tuk Tuk", genres: ["melodic", "techno"] },
      { title: "Customer Is King", genres: ["deep", "techno"] },
      { title: "Home", genres: ["melodic"] },
      { title: "After the Rain", genres: ["melodic"] },
    ],
  },
  {
    id: "zhu",
    ...
    blurb: "Anonymous-turned-icon whose smoky, sax-laced deep house started with the runaway hit 'Faded'.",
    topTracks: [
      { title: "Faded", genres: ["deep", "house"] },
      { title: "In the Morning", genres: ["deep"] },
      { title: "Generationwhy", genres: ["deep", "melodic"] },
      { title: "Came for the Low", genres: ["house", "deep"] },
    ],
  },
  {
    id: "elderbrook",
    name: "Elderbrook",
    aka: ["alexander kotz"],
    genres: ["melodic", "deep", "house"],
    blurb: "British singer-producer whose warm vocal house bridges underground and crossover.",
    topTracks: [
      { title: "Cola", genres: ["deep", "house"] },
      { title: "Something About You", genres: ["melodic", "deep"] },
      { title: "Numb", genres: ["melodic"] },
      { title: "My House", genres: ["deep", "house"] },
    ],
  },
  {
    id: "bob-moses",
    name: "Bob Moses",
    aka: ["tom howie", "jimmy vallance"],
    genres: ["melodic", "deep", "techno"],
    blurb: "Canadian duo whose brooding, songwriterly take on melodic house crossed into rock crowds.",
    topTracks: [
      { title: "Tearing Me Up", genres: ["melodic", "deep"] },
      { title: "Talk", genres: ["melodic"] },
      { title: "Back Down", genres: ["melodic", "techno"] },
      { title: "Love We Found", genres: ["melodic", "deep"] },
    ],
  },
  {
    id: "bicep",
    name: "Bicep",
    aka: ["matt mcbriar", "andy ferguson"],
    genres: ["melodic", "techno", "ukg"],
    blurb: "Belfast duo whose breakbeat-laced, nostalgic melodic techno made 'Glue' a modern classic.",
    topTracks: [
      { title: "Glue", genres: ["melodic", "ukg"] },
      { title: "Apricots", genres: ["melodic", "techno"] },
      { title: "Opal", genres: ["melodic"] },
      { title: "Saku", genres: ["melodic", "ukg"] },
    ],
  },

  // Bass / trap / future bass
  {
    id: "alison-wonderland",
    name: "Alison Wonderland",
    aka: ["alexandra sholler"],
    genres: ["futurebass", "trap", "dubstep"],
    blurb: "Australian artist whose emotional, vocal-led bass and trap made her a festival headliner.",
    topTracks: [
      { title: "Run", genres: ["futurebass"] },
      { title: "Church", genres: ["futurebass", "trap"] },
      { title: "Happy Place", genres: ["futurebass"] },
      { title: "Easy", genres: ["futurebass", "trap"] },
    ],
  },
  {
    id: "slander",
    name: "Slander",
    aka: ["derek andersen", "scott land"],
    genres: ["meldubstep", "futurebass", "dubstep"],
    blurb: "American duo who coined 'heaven trap' and now pack arenas with anthemic melodic dubstep.",
    topTracks: [
      { title: "Love Is Gone", genres: ["meldubstep", "futurebass"] },
      { title: "Potions", genres: ["dubstep", "meldubstep"] },
      { title: "Without You", genres: ["meldubstep"] },
      { title: "First Time", genres: ["meldubstep", "futurebass"] },
    ],
  },
  {
    id: "nghtmre",
    name: "NGHTMRE",
    aka: ["tyler marenyi"],
    genres: ["trap", "dubstep", "basshouse"],
    blurb: "American bass producer and Gud Vibrations co-founder bridging festival trap and dubstep.",
    topTracks: [
      { title: "Street", genres: ["trap", "dubstep"] },
      { title: "Gud Vibrations", genres: ["trap"] },
      { title: "Holdin On", genres: ["trap"] },
      { title: "REDLILGHT", genres: ["dubstep", "basshouse"] },
    ],
  },
  {
    id: "troyboi",
    name: "TroyBoi",
    aka: ["troy henry"],
    genres: ["trap", "glitchhop"],
    blurb: "London producer whose intricate, swing-heavy trap is a study in rhythmic detail.",
    topTracks: [
      { title: "Do You?", genres: ["trap"] },
      { title: "Afterhours", genres: ["trap"] },
      { title: "Mantra", genres: ["trap", "glitchhop"] },
      { title: "On My Own", genres: ["trap"] },
    ],
  },
  {
    id: "yellow-claw",
    name: "Yellow Claw",
    aka: ["jim aasgier", "nizzle"],
    genres: ["trap", "moombahton", "dubstep"],
    blurb: "Dutch crew fusing trap, moombahton and hip-hop into rowdy festival weaponry.",
    topTracks: [
      { title: "Shotgun", genres: ["trap"] },
      { title: "DJ Turn It Up", genres: ["trap", "moombahton"] },
      { title: "Krokobil", genres: ["moombahton"] },
      { title: "Till It Hurts", genres: ["trap"] },
    ],
  },
  {
    id: "virtual-riot",
    name: "Virtual Riot",
    aka: ["valentin brunn"],
    genres: ["dubstep", "meldubstep", "futurebass"],
    blurb: "German producer revered for surgical sound-design and genre-hopping bass virtuosity.",
    topTracks: [
      { title: "Idols", genres: ["dubstep"] },
      { title: "Energy Drink", genres: ["dubstep"] },
      { title: "One for All, All for One", genres: ["dubstep", "meldubstep"] },
      { title: "Lost It", genres: ["dubstep"] },
    ],
  },
  ...
  // Electronic / crossover
  {
    id: "kaytranada",
    name: "Kaytranada",
    aka: ["louis kevin celestin"],
    genres: ["house", "futurebass", "deep"],
    blurb: "Haitian-Canadian producer whose funk-soaked, syncopated house won a Grammy and a generation.",
    topTracks: [
      { title: "10%", genres: ["house"] },
      { title: "Glowed Up", genres: ["futurebass", "house"] },
      { title: "Lite Spots", genres: ["house"] },
      { title: "Be Your Girl", genres: ["house", "deep"] },
    ],
  },
  {
    id: "jamie-xx",
    name: "Jamie xx",
    aka: ["jamie smith"],
    genres: ["ukg", "house", "deep"],
    blurb: "The xx producer whose solo work turned UK rave nostalgia into crossover art-dance.",
    topTracks: [
      { title: "Gosh", genres: ["ukg", "house"] },
      { title: "Loud Places", genres: ["house", "deep"] },
      { title: "I Know There's Gonna Be (Good Times)", genres: ["house"] },
      { title: "Sleep Sound", genres: ["ukg", "deep"] },
    ],
  },
];
